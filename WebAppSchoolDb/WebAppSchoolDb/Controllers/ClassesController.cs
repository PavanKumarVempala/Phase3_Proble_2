    ...
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Classes != null ? 
                          ...
                          Problem("Entity set 'School_ProjectContext.Classes'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var @class = await _context.Classes
                .FirstOrDefaultAsync(m => m.Class1 == id);
            if (@class == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Class1")] Class @class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Class1")] Class @class)
        {
            if (id != @class.Class1)
            {
                return NotFound();
